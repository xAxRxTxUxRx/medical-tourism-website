...
export const DENTAL_CATEGORIES = [
  {
    ...
    services: [
      { name: 'Лечение кариеса', desc: 'Бережное лечение с сохранением здоровых тканей зуба', price: 1800, ru: 5500 },
      { name: 'Лечение эрозии эмали', desc: 'Восстановление и укрепление эмали зуба', price: 2000, ru: 5000 },
      { name: 'Ультразвуковая чистка зубов', desc: 'Бережное удаление зубного камня и налёта современными технологиями', price: 2200, ru: 6000 },
      { name: 'Герметизация фиссур', desc: 'Профилактика кариеса в естественных бороздках зубов', price: 1500, ru: 4000 },
    ],
  },
  {
    id: 'orthopedics',
    ...
    services: [
      { name: 'Металлокерамическая коронка', desc: 'Популярный выбор — сочетание прочности и эстетики', price: 2600, ru: 6500 },
      { name: 'Циркониевая коронка', desc: 'Высокая прочность и эстетика, подходит для всех зон рта', price: 8800, ru: 22000 },
      { name: 'Виниры и люминиры', desc: 'Тонкие керамические накладки, улучшают вид передних зубов', price: 10000, ru: 28000 },
    ],
  },
  {
    id: 'implant',
    ...
    services: [
      ...
      { name: 'Классическая имплантация (имплант)', desc: 'Установка титанового корня под местной анестезией', price: 19000, ru: 45000 },
    ],
  },
  {
    id: 'prosthetics',
    ...
    services: [
      { name: 'Бюгельный протез', desc: 'Прочная конструкция из металла и акрила, равномерно распределяет нагрузку', price: 18600, ru: 42000 },
      { name: 'Нейлоновый протез', desc: 'Современный гибкий вариант, комфортное ношение', price: 28600, ru: 60000 },
...
export const PRICES = [
  { name: 'Лечение кариеса', price: 1800, ru: 5500 },
  { name: 'Лечение эрозии эмали', price: 2000, ru: 5000 },
  { name: 'Ультразвуковая чистка зубов', price: 2200, ru: 6000 },
